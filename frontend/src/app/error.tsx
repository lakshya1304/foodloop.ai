    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 p-6">
      <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 max-w-lg w-full text-center space-y-6">
        ...
        <p className="text-slate-500 font-medium text-sm">
          A rendering error occurred in this section of the application. You can try recovering the page or perform a hard reset if you suspect a stale production build.
        </p>
